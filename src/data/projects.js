    ...
    [
        {
            ...
            'Name': 'Covid Info',
            'image': [
                'https://res.cloudinary.com/dvupfwoil/image/upload/v1631743525/PortfolioImages/Mobile/CovidInfo_wdqdvv.png'
            ],
            'Description':
            {
                'descTitle': 'Xamarin Forms Application',
        ...
        },
        {
            ...
            'Description': {
                ...
                'descBody': 'Application created with React JS. It is a calendar application to schedule events',
            },
            'techItem': ['HTML', 'BOOTSTRAP 5', 'REACT JS', 'REDUX', 'REACT-ROUTER', 'REACT-BIG-CALENDAR', "SWEETALERT"]
        },
        {
            'Id': 7,
            'Category': 'Backend',
        ...
        },
        {
            ...
            'Description': {
                'descTitle': 'React JS Application',
                'descBody': 'Single page application made with React JS, to create courses, users, image management, etc. Material-ui was implemented for the design of the application'
            },
            'techItem': ['REACT JS', 'REDUX', 'REACT-ROUTER', 'MATERIAL-UI']
        },
        {
            'Id': 9,
            'Category': 'Backend',
        ...
        },
        {
            ...
            'Name': 'Journal App',
            'image': ['https://res.cloudinary.com/dvupfwoil/image/upload/v1631750439/PortfolioImages/Web/JournalApp/JournalAppCovers_wdmvyo.png'],
            'Description': {
                'descTitle': 'React JS Application',
                'descBody': 'Single page app with Sass, css animations with animate.style. Google authentication and email authentication using Firebase. Application to write notes from day to day, you can also upload one or more images that refer to the text you write in the note'
            },
            'techItem': ['HTML', 'SASS', 'REACT JS', 'REACT-REDUX', 'REDUX', 'SWEETALERT', 'VALIDATOR', 'FIREBASE']
        },
        {
            'Id': 5,
            'Category': 'Frontend',
            ...
            'urlWeb': '',
            'Name': 'Hero App',
            'image': ['https://res.cloudinary.com/dvupfwoil/image/upload/v1631751117/PortfolioImages/Web/HeroesApp/HeroesAppCover_fzflbr.png'],
            'Description': {
                'descTitle': 'React JS Application',
                'descBody': 'Single page app to view information about some DC and MARVEL heroes'
            },
            'techItem': ['HTML', 'BOOTSTRAP 5', 'REACT JS', 'REACT-ROUTER']
        },
        {
            'Id': 3,
            'Category': 'Frontend',
        ...
        },
        {
            ...
            'image': ['https://res.cloudinary.com/dvupfwoil/image/upload/v1631752326/PortfolioImages/Web/CompanyHomePage/CompanyHomePage_aofsr8.png'],
            'Description': {
                'descTitle': 'Basic Web Page',
                'descBody': 'Landing page layout of a fictitious company, using css and media queries'
            },
        ...
        },
        {
            ...
            'Name': 'Coffe Club',
            'image': ['https://res.cloudinary.com/dvupfwoil/image/upload/v1631752551/PortfolioImages/Web/CoffePage/CoffePageCover_sc9esd.png'],
            'Description': {
                'descTitle': 'Basic Web Page',
                'descBody': 'Landing page layout of a fictitious company, using css and media queries'
            },
