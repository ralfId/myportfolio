        ...
        <div className="d-flex flex-column">
          ...
          <div className="profile">
            ...
            <div className="social-links mt-3 text-center">
              <a href="http://localhost:3000/index" className="twitter"><i className="bx bxl-twitter"></i></a>
              <a href="http://localhost:3000/index" className="facebook"><i className="bx bxl-facebook"></i></a>
              <a href="http://localhost:3000/index" className="instagram"><i className="bx bxl-instagram"></i></a>
              <a href="http://localhost:3000/index" className="google-plus"><i className="bx bxl-skype"></i></a>
              <a href="http://localhost:3000/index" className="linkedin"><i className="bx bxl-linkedin"></i></a>
            </div>
          </div>
