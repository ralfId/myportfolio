        ...
        <div className="d-flex flex-column">
          ...
          <div className="profile">
            ...
            <div className="social-links mt-3 text-center">
              <a href="https://twitter.com/ralf_id" className="twitter" target="_blank"><i className="bx bxl-twitter"></i></a>
              <a href="mailto:ralf_raid@outlook.es" className="mail" target="_blank"><i class="bi bi-envelope"></i></a>
              <a href="http://localhost:3000/index" className="instagram" target="_blank"><i className="bx bxl-instagram"></i></a>
              <a href="hhttps://www.linkedin.com/in/rafaelid/" className="linkedin" target="_blank"><i className="bx bxl-linkedin"></i></a>
            </div>
          </div>
